...
public class Tmio1Servicio implements Serializable {
	...
	@NotNull
	private LocalDate tmioFechaInicio;
	
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@NotNull
	private LocalDate tmioFechaFin;
	...
	public LocalDate getTmioFechaInicio() {
		return tmioFechaInicio;
	}

	public void setTmioFechaInicio(LocalDate tmioFechaInicio) {
		this.tmioFechaInicio = tmioFechaInicio;
	}

	public LocalDate getTmioFechaFin() {
		return tmioFechaFin;
	}

	public void setTmioFechaFin(LocalDate tmioFechaFin) {
